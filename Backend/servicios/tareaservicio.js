...
function crearTarea(id_usuario, titulo, descripcion = null) {
  const sql = cargarSQLPorNombre("./consultas/tarea.sql", "crear_tarea");
...
function obtenerTarea(id_tarea) {
  const sql = cargarSQLPorNombre("./consultas/tarea.sql", "obtener_tarea");
  return new Promise((resolve, reject) => {
...
function obtenerTareasPorUsuario(id_usuario) {
  const sql = cargarSQLPorNombre("./consultas/tarea.sql", "obtener_tareas_por_usuario");
  return new Promise((resolve, reject) => {
...
function eliminarTarea(id_tarea) {
  const sql = cargarSQLPorNombre("./consultas/tarea.sql", "eliminar_tarea");
  return new Promise((resolve, reject) => {
